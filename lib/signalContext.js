...
// descriptor from the search term the brand already carries, and flags the
// genuine standouts.
//
// WHY THIS EXISTS:
...
//   This module is that fuel. It does the math once per run; the analysis
//   service attaches each brand its block and feeds it to the model.
//
...
//   { name, displayName, identity, category, signals, concordance }
