...
export const BRAND_TAXONOMY = {
  ...
  // ======================================================================
  // ANCHOR ADDITIONS (2026-06): 81 brands from the monthly anchor roster.
  // Spirits subtypes collapse to spirits per the 8-category model.
  // ======================================================================
  // ----- SPIRITS: Vodka -----
  altamura:           { display: 'Altamura',            category: 'spirits', searchTerm: 'Altamura vodka', redditAmbiguous: true },
  beluga:             { display: 'Beluga',              category: 'spirits', searchTerm: 'Beluga vodka', redditAmbiguous: true },
  ciroc:              { display: 'Cîroc',               category: 'spirits', searchTerm: 'Cîroc vodka' },
  haku:               { display: 'Haku',                category: 'spirits', searchTerm: 'Haku vodka', redditAmbiguous: true },
  nemiroff:           { display: 'Nemiroff',            category: 'spirits', searchTerm: 'Nemiroff vodka' },
  zubrowka:           { display: 'Żubrówka',            category: 'spirits', searchTerm: 'Żubrówka vodka' },

  // ----- SPIRITS: Gin -----
  boatyard:           { display: 'Boatyard',            category: 'spirits', searchTerm: 'Boatyard gin', redditAmbiguous: true },
  citadelle:          { display: 'Citadelle',           category: 'spirits', searchTerm: 'Citadelle gin', redditAmbiguous: true },
  'ginebra san miguel': { display: 'Ginebra San Miguel', category: 'spirits', searchTerm: 'Ginebra San Miguel gin', redditAmbiguous: true },
  gordons:            { display: "Gordon's",            category: 'spirits', searchTerm: "Gordon's gin", redditAmbiguous: true },

  // ----- SPIRITS: Rum -----
  brugal:             { display: 'Brugal',              category: 'spirits', searchTerm: 'Brugal rum' },
  'old monk':         { display: 'Old Monk',            category: 'spirits', searchTerm: 'Old Monk rum', redditAmbiguous: true },
  tanduay:            { display: 'Tanduay',             category: 'spirits', searchTerm: 'Tanduay rum' },
  zacapa:             { display: 'Zacapa',              category: 'spirits', searchTerm: 'Zacapa rum', redditAmbiguous: true },

  // ----- SPIRITS: Tequila -----
  'el tesoro':        { display: 'El Tesoro',           category: 'spirits', searchTerm: 'El Tesoro tequila', redditAmbiguous: true },
  lalo:               { display: 'LALO',                category: 'spirits', searchTerm: 'LALO tequila', redditAmbiguous: true },
  'olmeca altos':     { display: 'Olmeca Altos',        category: 'spirits', searchTerm: 'Olmeca Altos tequila' },

  // ----- SPIRITS: Scotch -----
  ballantines:        { display: "Ballantine's",        category: 'spirits', searchTerm: "Ballantine's scotch" },
  buchanans:          { display: "Buchanan's",          category: 'spirits', searchTerm: "Buchanan's whisky", redditAmbiguous: true },
  grants:             { display: "Grant's",             category: 'spirits', searchTerm: "Grant's whisky", redditAmbiguous: true },
  dalmore:            { display: 'The Dalmore',         category: 'spirits', searchTerm: 'Dalmore scotch' },

  // ----- SPIRITS: Brandy & Cognac -----
  ararat:             { display: 'Ararat',              category: 'spirits', searchTerm: 'Ararat brandy', redditAmbiguous: true },
  'cardenal mendoza': { display: 'Cardenal Mendoza',    category: 'spirits', searchTerm: 'Cardenal Mendoza brandy' },
  'carlos i':         { display: 'Carlos I',            category: 'spirits', searchTerm: 'Carlos I brandy', redditAmbiguous: true },
  emperador:          { display: 'Emperador',           category: 'spirits', searchTerm: 'Emperador brandy', redditAmbiguous: true },
  fundador:           { display: 'Fundador',            category: 'spirits', searchTerm: 'Fundador brandy' },
  'mansion house':    { display: 'Mansion House',       category: 'spirits', searchTerm: 'Mansion House brandy', redditAmbiguous: true },
  'old admiral':      { display: 'Old Admiral',         category: 'spirits', searchTerm: 'Old Admiral brandy', redditAmbiguous: true },
  'torres brandy':    { display: 'Torres',              category: 'spirits', searchTerm: 'Torres brandy', redditAmbiguous: true },

  // ----- SPIRITS: American Whiskey -----
  balcones:           { display: 'Balcones',            category: 'spirits', searchTerm: 'Balcones whisky', redditAmbiguous: true },
  'george dickel':    { display: 'George Dickel',       category: 'spirits', searchTerm: 'George Dickel whisky' },
  'old overholt':     { display: 'Old Overholt',        category: 'spirits', searchTerm: 'Old Overholt rye' },
  'redwood empire':   { display: 'Redwood Empire',      category: 'spirits', searchTerm: 'Redwood Empire whiskey', redditAmbiguous: true },
  'sagamore spirit':  { display: 'Sagamore Spirit',     category: 'spirits', searchTerm: 'Sagamore Spirit whiskey' },
  stranahans:         { display: "Stranahan's",         category: 'spirits', searchTerm: "Stranahan's whiskey" },
  'templeton rye':    { display: 'Templeton Rye',       category: 'spirits', searchTerm: 'Templeton Rye whiskey' },
  'uncle nearest':    { display: 'Uncle Nearest',       category: 'spirits', searchTerm: 'Uncle Nearest whiskey' },
  westland:           { display: 'Westland',            category: 'spirits', searchTerm: 'Westland whiskey', redditAmbiguous: true },
  westward:           { display: 'Westward',            category: 'spirits', searchTerm: 'Westward whiskey', redditAmbiguous: true },

  // ----- SPIRITS: Japanese Whisky -----
  akashi:             { display: 'Akashi',              category: 'spirits', searchTerm: 'Akashi whisky', redditAmbiguous: true },
  fuji:               { display: 'Fuji',                category: 'spirits', searchTerm: 'Fuji whisky', redditAmbiguous: true },
  hakushu:            { display: 'Hakushu',             category: 'spirits', searchTerm: 'Hakushu whisky' },
  hibiki:             { display: 'Hibiki',              category: 'spirits', searchTerm: 'Hibiki whisky', redditAmbiguous: true },
  chichibu:           { display: "Ichiro's Malt",       category: 'spirits', searchTerm: 'Chichibu Japanese whisky' },
  kanosuke:           { display: 'Kanosuke',            category: 'spirits', searchTerm: 'Kanosuke whisky' },
  kurayoshi:          { display: 'Kurayoshi',           category: 'spirits', searchTerm: 'Kurayoshi whisky' },
  'mars komagatake':  { display: 'Mars Komagatake',     category: 'spirits', searchTerm: 'Mars Komagatake whisky', redditAmbiguous: true },
  miyagikyo:          { display: 'Miyagikyo',           category: 'spirits', searchTerm: 'Miyagikyo whisky' },
  nikka:              { display: 'Nikka',               category: 'spirits', searchTerm: 'Nikka whisky', redditAmbiguous: true },
  'suntory kakubin':  { display: 'Suntory Kakubin',     category: 'spirits', searchTerm: 'Suntory Kakubin whisky' },
  taketsuru:          { display: 'Taketsuru',           category: 'spirits', searchTerm: 'Taketsuru whisky' },
  toki:               { display: 'Toki',                category: 'spirits', searchTerm: 'Suntory Toki whisky', redditAmbiguous: true },
  yamazaki:           { display: 'Yamazaki',            category: 'spirits', searchTerm: 'Yamazaki whisky', redditAmbiguous: true },
  yoichi:             { display: 'Yoichi',              category: 'spirits', searchTerm: 'Yoichi whisky', redditAmbiguous: true },

  // ----- SPIRITS: Liqueur -----
  'amaro montenegro': { display: 'Amaro Montenegro',    category: 'spirits', searchTerm: 'Amaro Montenegro liqueur' },
  disaronno:          { display: 'Disaronno',           category: 'spirits', searchTerm: 'Disaronno amaretto' },
  'licor 43':         { display: 'Licor 43',            category: 'spirits', searchTerm: 'Licor 43 liqueur' },
  'luxardo maraschino': { display: 'Luxardo',           category: 'spirits', searchTerm: 'Luxardo Maraschino liqueur' },

  // ----- WINE -----
  'romanee-conti':    { display: 'Domaine de la Romanée-Conti', category: 'wine', searchTerm: 'Domaine de la Romanée-Conti wine' },
  'familia torres':   { display: 'Familia Torres',      category: 'wine', searchTerm: 'Familia Torres wine', redditAmbiguous: true },

  // ----- BEER -----
  brahma:             { display: 'Brahma',              category: 'beer', searchTerm: 'Brahma beer', redditAmbiguous: true },
  carlsberg:          { display: 'Carlsberg',           category: 'beer', searchTerm: 'Carlsberg beer' },
  'pilsner urquell':  { display: 'Pilsner Urquell',     category: 'beer', searchTerm: 'Pilsner Urquell beer' },
  tsingtao:           { display: 'Tsingtao',            category: 'beer', searchTerm: 'Tsingtao beer' },

  // ----- NON-ALC -----
  'best day brewing': { display: 'Best Day Brewing',    category: 'non-alc', searchTerm: 'Best Day Brewing non-alcoholic' },
  'french bloom':     { display: 'French Bloom',        category: 'non-alc', searchTerm: 'French Bloom non-alcoholic sparkling' },
  leitz:              { display: 'Leitz',               category: 'non-alc', searchTerm: 'Leitz non-alcoholic wine', redditAmbiguous: true },
  'lucky saint':      { display: 'Lucky Saint',         category: 'non-alc', searchTerm: 'Lucky Saint non-alcoholic beer' },
  oddbird:            { display: 'Oddbird',             category: 'non-alc', searchTerm: 'Oddbird non-alcoholic wine' },

  // ----- ENERGY -----
  nos:                { display: 'NOS',                 category: 'energy', searchTerm: 'NOS energy drink', redditAmbiguous: true },
  'sting energy':     { display: 'Sting',               category: 'energy', searchTerm: 'Sting energy drink', redditAmbiguous: true },

  // ----- THC -----
  ayrloom:            { display: 'Ayrloom',             category: 'thc', searchTerm: 'Ayrloom THC' },
  brez:               { display: 'Brez',                category: 'thc', searchTerm: 'Brez THC drink', redditAmbiguous: true },
  cantrip:            { display: 'Cantrip',             category: 'thc', searchTerm: 'Cantrip THC drink', redditAmbiguous: true },
  'crescent 9':       { display: 'Crescent 9',          category: 'thc', searchTerm: 'Crescent 9 THC seltzer' },
  'delta crush':      { display: 'Delta Crush',         category: 'thc', searchTerm: 'Delta Crush THC' },
  houseplant:         { display: 'Houseplant',          category: 'thc', searchTerm: 'Houseplant cannabis', redditAmbiguous: true },
  keef:               { display: 'Keef',                category: 'thc', searchTerm: 'Keef cannabis drink', redditAmbiguous: true },
  nowadays:           { display: 'Nowadays',            category: 'thc', searchTerm: 'Nowadays THC drink', redditAmbiguous: true },
  ohho:               { display: 'oHHo',                category: 'thc', searchTerm: 'oHHo CBD THC' },
  senorita:           { display: 'Señorita',            category: 'thc', searchTerm: 'Señorita THC drink', redditAmbiguous: true },
};
